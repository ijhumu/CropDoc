...
public class rv_adapter2 extends RecyclerView.Adapter<holder> {
...
public rv_adapter2(int[] img1, String[] txt1, Context context) {
    this.img1 = img1;
    this.txt1 = txt1;
...
public void onBindViewHolder(@NonNull holder holder, @SuppressLint("RecyclerView") int position) {
    ...
    dbase_string="disease_details";
    holder.cardView.setCardBackgroundColor(context.getColor(R.color.disease));
